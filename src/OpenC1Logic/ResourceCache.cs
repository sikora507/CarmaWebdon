...
namespace OpenC1Logic
{
    static class ResourceCache
    {
        ...
        {
            return _pixMaps.Find(p => p.Name.Equals(name, StringComparison.OrdinalIgnoreCase));
        }

        public static CMaterial GetMaterial(string name)
        {
            return _materials.Find(m => m.Name.Equals(name, StringComparison.OrdinalIgnoreCase));
        }
