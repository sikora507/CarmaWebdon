...
namespace OpenC1Logic.Parsers
{
    ...
    public class PixFile : BaseDataFile
    {
        enum PixBlockType
        {
            Null = 0,
                ...
                switch (blockType)
                {
                    ...
                    case PixBlockType.PixelData:
                        ...
                        if (bytesPerPixel == 1)
                        {
                            ...
                            bgrArray = Helpers.GetBytesForImage(pixels, currentPix.Width, currentPix.Height, GameVars.Palette);
                        }
